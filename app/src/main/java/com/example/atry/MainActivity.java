...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvName = findViewById(R.id.tv_name);//nam
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar snackbar= Snackbar.make(view,"Taking you to next windows in 2 seconds",Snackbar.LENGTH_SHORT);
                snackbar.show();
        ...
        findViewById(R.id.shareImg).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar snackbar= Snackbar.make(v,"Your referal code is: 24444",Snackbar.LENGTH_LONG);
                snackbar.show();
            }
        });
